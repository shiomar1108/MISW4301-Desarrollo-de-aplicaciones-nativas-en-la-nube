...
from validators.validators import validateUUID, validateToken
...
class QueryPost(BaseCommannd):
    def __init__(self, post_request_args):
        self.checkArguments(post_request_args)
    
    def checkArguments(self, post_request_args):
